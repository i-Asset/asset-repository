...
import at.srfg.iasset.network.services.BrokerService;
...
public class BrokerController {
	private final BrokerService enterpriseService;
	/**
	...
	public BrokerController(BrokerService enterpriseService) {
	...
	public Broker create(@Valid @RequestBody Broker input) {
        if (input.getId() != null) {
    ...
    public Broker get(@NotNull @PathVariable Long id) {
    ...
    public Broker update(@PathVariable Long id, @Valid @RequestBody Broker input) {
    ...
    @PreAuthorize("hasAuthority('app_admin')")
    public Broker delete(@NotNull @PathVariable Long id) {
