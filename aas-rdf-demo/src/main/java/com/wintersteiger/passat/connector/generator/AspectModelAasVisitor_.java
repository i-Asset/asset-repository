...
import com.wintersteiger.passat.connector.generator.AspectModelAasVisitor_.SubmodelElementBuilder;

public class AspectModelAasVisitor_ implements AspectVisitor<Environment, Context> {
   ...
   public AspectModelAasVisitor_ withPropertyMapper( final PropertyMapper<?> propertyMapper ) {
