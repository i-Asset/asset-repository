    ...
    public static AssetAdministrationShell createRootApplication() {
    	return new DefaultAssetAdministrationShell.Builder()
    			...
    			.description(new DefaultLangStringTextType.Builder()
    					...
    					.build())
    			.submodels(ReferenceUtils.toReference(createSubmodelForInfoModel()))
    			.submodels(ReferenceUtils.toReference(createSubmodelForRootEventConfiguration()))
    			.build();
...
//    							.levelType(LevelType.NOM)
    ...
    public static ConceptDescription createConceptDescriptionForMessageBroker() {
        return new DefaultConceptDescription.Builder()
                ...
                .description(Arrays.asList(
                        new DefaultLangStringTextType.Builder().text("Concept referencing the messageBroker").language("en").build(),
                        new DefaultLangStringTextType.Builder().text("Concept zum MessageBroker ").language("de").build()
                        ))
                .administration(new DefaultAdministrativeInformation.Builder()
                        .version("0.9")
                        .revision("0")
    ...
    public static ConceptDescription createConceptDescriptionForMessageBrokerHosts() {
        return new DefaultConceptDescription.Builder()
                ...
                .description(Arrays.asList(
                        new DefaultLangStringTextType.Builder().text("Concept referencing the messageBroker's host definition").language("en").build(),
                        new DefaultLangStringTextType.Builder().text("Concept zum MessageBroker ").language("de").build()
                        ))
                .administration(new DefaultAdministrativeInformation.Builder()
                        .version("0.9")
    ...
    public static ConceptDescription createConceptDescriptionForMessageBrokerBrokerType() {
        return new DefaultConceptDescription.Builder()
                ...
                .category("ConceptProperty")
                .description(Arrays.asList(
                        new DefaultLangStringTextType.Builder().text("Concept referencing the messageBroker's type definiton").language("en").build(),
                        new DefaultLangStringTextType.Builder().text("Concept zum MessageBroker ").language("de").build()
                        ))
                .administration(new DefaultAdministrativeInformation.Builder()
                        .version("0.9")
