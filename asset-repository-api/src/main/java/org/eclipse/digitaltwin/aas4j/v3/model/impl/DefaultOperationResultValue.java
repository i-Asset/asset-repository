...
import org.eclipse.digitaltwin.aas4j.v3.model.builder.OperationResultValueBuilder;
...
public class DefaultOperationResultValue implements OperationResultValue {
  ...
  public boolean equals(Object obj) {
    if (this == obj) {
      ...
      DefaultOperationResultValue other = (DefaultOperationResultValue) obj;
  ...
  public static class Builder extends OperationResultValueBuilder<DefaultOperationResultValue, Builder> {
    ...
    @Override
    protected DefaultOperationResultValue newBuildingInstance() {
      return new DefaultOperationResultValue();
    }
  }
}
