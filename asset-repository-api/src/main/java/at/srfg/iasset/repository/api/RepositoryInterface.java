 ...
 */
@Path("")
@RequestMapping(path = "api/3.0/")
public interface RepositoryInterface {
	final String PATH_SHELLS 					= "/shells";
	final String AAS_IDENTIFIER					= "/{aasIdentifier}";
	final String PATH_ASSET_INFORMATION			= "/asset-information";
	final String PATH_THUMBNAIL					= "/thumbnail";
	final String PATH_AAS_SUBMODELS				= "/submodels";
	final String PATH_SUBMODEL_REFS				= "/submodel-refs";
	 ...
	 * @return
	 */
	@Operation(summary =  "Get the Asset Information for AssetAdministrationShell",
			tags = "Asset Administration Shell Repository Interface (for Connector)")
	@RequestMapping(
			method = RequestMethod.GET,
			path=PATH_SHELLS + AAS_IDENTIFIER + PATH_ASSET_INFORMATION)
...
//			Reference element);
	...
	/**
	 * Add a new model element to the {@link RepositoryInterface}. The element must
	...
	public void setSubmodelElement(
			...
			SubmodelElement element);
	/**
	 * Remove an element from the {@link RepositoryInterface}. The element must 
