...
//			tags = "Asset Administration Shell Interface")
//	@RequestMapping(
...
//			Reference element);
	...
	@RequestMapping(
			method = RequestMethod.GET,
			path=PATH_AAS_SUBMODELS + SUBMODEL_IDENTIFIER + PATH_SUBMODEL_ELEMENTS + IDSHORT_PATH_WILDCARD)
	public Referable getSubmodelElement(
//			@Base64Encoded
//			@Parameter(
//					in = ParameterIn.PATH, 
...
//			String aasIdentifier,			
	...
	/**
	 * Add a new model element to the {@link IAssetAdministrationShellInterface}. The element must
...
//			String aasIdentifier,
			...
			SubmodelElement element);
	/**
	 * Remove an element from the {@link IAssetAdministrationShellInterface}. The element must 
